<?php 
        include 'Controllers'.DIRECTORY_SEPARATOR.'code.php' ;
              ...
              <div class="card">
                <div class="card-body">
                  ...
                  <p class="card-description display-5">
                   Code source de la page , coté pdf  
                  </p>
                    ...
                    <table id="recent-purchases-listing" class="table">
                      ...
                      <?php if(isset($recuperation)&& !empty($recuperation)){
                        ...
                        <tr>
                            ...
                            <td><a href="pdf_source.php?id=<?php echo $toto['id'];?>"><button class="btn btn-primary btn-rounded" name="modifier">modifier</button></a></td>
                            <td><a href="pdf_source.php?id=<?php echo $toto['id'];?>&para=<?php echo$toto['file_namo'];?>"><button class="btn btn-danger btn-rounded supprimer" id="supprimer">supprimer</button></a></td>
                        </tr>
                        <?php } }?>
                        <tr>
                      </tbody>
