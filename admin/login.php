        ...
        <div class="row flex-grow">
          <div class="col-lg-6 d-flex align-items-center justify-content-center">
            <div class="auth-form-transparent text-left p-3">
              ...
              <h6 class="font-weight-light">Administrez votre site </h6>
              <form class="pt-3">
                <div class="form-group">
                  <label for="exampleInputEmail">pseudo</label>
                  <div class="input-group">
                    ...
                    <input type="text" class="form-control form-control-lg border-left-0" id="exampleInputEmail" placeholder="votre pseudo">
                  </div>
                </div>
                <div class="form-group">
