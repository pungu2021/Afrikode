                    ...
                    <form action="trai.php" method="post">
                        <section class="row">
                              <aside class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                  ...
                                  <input type="text" name="pseudo1" id="pseudo1"class="bow">
                            </aside>
                            <aside class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                              <label for="com">Email</label><br>
                              <input type="email" name="gmail1" id="gmail1"class="bow">
                            </aside>
                            <aside class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                <label for="com">Message</label><br>
                                <textarea name="message1" id="message1" cols="30" rows="10" class="box1"></textarea>
                            </aside>
                        </section>
